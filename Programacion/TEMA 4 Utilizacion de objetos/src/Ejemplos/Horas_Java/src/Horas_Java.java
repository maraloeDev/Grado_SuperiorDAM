...
public class Horas_Java {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Composición a partir de composiciones externas
            ...
            //Composición de hora a partir de datos externos
            LocalTime hora2 = LocalTime.of(15, 13, 40);
            System.out.println("La hora 2 es " + hora2);

            //A la hora1 se le añadiran 2 horas y se le restaran 45 min
            LocalTime hora3 = hora1.plusHours(2).minusMinutes(45);
            System.out.println("La hora3 es " + hora3);
            //A la hora2 se le restaran 2 horas y 15 minutos y se añadiran 40 segundos
